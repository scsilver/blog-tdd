...
$(document).ready(function(){
  ...
  $('.col-xs-10').on('scroll', function(){
      ...
      var colorb = 'rgb(245,78,98)';
         color = 'background-color:' + fadeToColor(colora,colorb,percentage/100);
      function fadeToColor(rgbColor1, rgbColor2, ratio) {
        ...
        document.styleSheets[2].addRule('.flat', 'color: blue');
        document.styleSheets[2].addRule('.flat::-webkit-progress-value', color);
        document.styleSheets[2].addRule('.flat::-moz-progress-bar', color);
